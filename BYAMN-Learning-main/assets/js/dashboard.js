            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover-lift transition-all duration-300 course-card" data-enrollment-id="${enrollment.id}">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6 flex justify-between">
                        ...
                        ${isCompleted ? `
                            <a 
                                href="../certificate.html?courseId=${enrollment.courseId}${enrollment.certificateId ? '&certId=' + enrollment.certificateId : ''}"
                    ...
                    ${isCompleted ? `
                        <div class="mt-4 text-center">
                            ${enrollment.certificateId ? `
                                <a href="../verification.html?certId=${enrollment.certificateId}" class="text-sm text-indigo-600 hover:underline">
                                    Verify Certificate
                                </a>
                            ` : `
